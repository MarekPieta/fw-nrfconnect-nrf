...
* :ref:`bt_fast_pair_readme` library:
  ...
  * Removed:
    ...
    * The default override for the :kconfig:option:`CONFIG_BT_DIS` and :kconfig:option:`CONFIG_BT_DIS_FW_REV` Kconfig options that enables these options together with the Google Fast Pair Service.
    ...
    * The default override for the :kconfig:option:`CONFIG_BT_DIS_FW_REV_STR` Kconfig option that was set to :kconfig:option:`CONFIG_MCUBOOT_IMGTOOL_SIGN_VERSION` if :kconfig:option:`CONFIG_BOOTLOADER_MCUBOOT` was enabled.
      The default override is now handled in the Kconfig of the Zephyr Device Information Service (DIS) module and is based on the Zephyr's :ref:`zephyr:app-version-details` that uses the :file:`VERSION` file.

  * Updated the defaults for the following Fast Pair Kconfig options: :kconfig:option:`CONFIG_BT_FAST_PAIR_SUBSEQUENT_PAIRING`, :kconfig:option:`CONFIG_BT_FAST_PAIR_REQ_PAIRING`, :kconfig:option:`CONFIG_BT_FAST_PAIR_PN` and :kconfig:option:`CONFIG_BT_FAST_PAIR_GATT_SERVICE_MODEL_ID`.
