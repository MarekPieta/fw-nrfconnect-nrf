...
* Added:
  ...
  * Debug and release application configurations acting as a dongle for nRF54H20 Development Kit (``mrf54h20dk/nrf54h20/cpuapp``).
...
* Updated:
  ...
  * Low Latency Packet Mode (LLPM) dependency in the :ref:`nrf_desktop_ble_conn_params`.
    The module relies on :kconfig:option:`CONFIG_CAF_BLE_USE_LLPM` Kconfig option.
    This allows using the module also in case Bluetooth LE controller is not part of the main application.
