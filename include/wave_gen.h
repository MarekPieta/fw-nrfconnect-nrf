 ...
 *
 * @param time[in]	Time for generated value.
 * @param params[in]	Parameters describing generated wave signal.
 * @param out_val[out]	Pointer to the variable that is used to store generated value.
 *
