...
from configurator_core import get_device_pid, open_device, fwinfo, fwreboot, change_config, fetch_config, dfu
...
def perform_dfu(dev, args):
    ...
    return dfu(dev, recipient, dfu_image, progress_bar)
