...
class EventManagerInfo():
    def __init__(self, root_path):
        ...
        c_src = EventManagerInfo._parse_src_code(self.src_dir_path, postfix='.c')
        h_src = EventManagerInfo._parse_src_code(self.src_dir_path, postfix='.h')
