...
#define SHIFT_WINDOWS		CONFIG_EI_APP_ML_RUNNER_WINDOW_SHIFT
#define SHIFT_FRAMES		CONFIG_EI_APP_ML_RUNNER_FRAME_SHIFT

BUILD_ASSERT(SHIFT_WINDOWS >= 0);
BUILD_ASSERT(SHIFT_FRAMES >= 0);
