...
Sample mouse or dongle (``nrf54h20dk/nrf54h20/cpuapp``)
      ...
      * The configurations use the Software Updates for Internet of Things (SUIT) and supports firmware updates using the :ref:`nrf_desktop_dfu`.
        Configurations acting as HID peripherals also support firmware updates using the :ref:`nrf_desktop_smp`.
