 ...
 *
 * The function initializes global data of HID keymap utility.
 *
 ...
 *
 * The function maps the application-specific key ID to HID keymap entry containing HID report ID
 * and HID usage ID.
 *
