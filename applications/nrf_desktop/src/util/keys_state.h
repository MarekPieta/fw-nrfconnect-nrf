 ...
 * @param[out] keys_changed	The boolean under pointer is set to true if keys state changed.
 *
 * @retval 0 on success.
 ...
 *
 * The function asserts if size of the provided array is too small to handle the worst case.
 *
 * @param[in] ks	A keys state object.
 * @param[out] keys	Array to be filled with key IDs of active keys.
 * @param[in] keys_size	Size of the provided array.
 *
